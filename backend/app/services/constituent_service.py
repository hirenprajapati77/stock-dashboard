class ConstituentService:
    ...
    SECTOR_CONSTITUENTS = {
        ...
        "NIFTY_AUTO": ["M&M.NS", "SONACOMS.NS", "MARUTI.NS", "BAJAJ-AUTO.NS", "EICHERMOT.NS", "TVSMOTOR.NS", "HEROMOTOCO.NS", "BHARATFORG.NS", "ASHOKLEY.NS", "MOTHERSON.NS"],
        ...
        "NIFTY_REALTY": ["DLF.NS", "GODREJPROP.NS", "OBEROIRLTY.NS", "PHOENIXLTD.NS", "PRESTIGE.NS", "BRIGADE.NS", "SOBHA.NS", "LODHA.NS", "KOLTEPATIL.NS", "MAHLIFE.NS"],
        "NIFTY_PSU_BANK": ["SBIN.NS", "BANKBARODA.NS", "PNB.NS", "CANBK.NS", "UNIONBANK.NS", "INDIANB.NS", "BANKINDIA.NS", "IOB.NS", "UCOBANK.NS", "CENTRALBK.NS"],
        "NIFTY_MEDIA": ["SUNTV.NS", "ZEEL.NS", "PVRINOX.NS", "NAZARA.NS", "HATHWAY.NS", "NETWORK18.NS", "NDTV.NS", "TVTODAY.NS"]
    }
