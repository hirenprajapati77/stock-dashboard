...
class BreakoutClassifier:
    ...
    def analyze(self, features: dict):
        ...
        result = {
            ...
            "reason": "Breakout quality cannot be trusted yet because volume and range expansion do not provide enough confirmation. Avoid entering until price shows a clearer breakout or retest.",
            ...
            try:
                ...
                if prob > 0.6:
                    ...
                    if ml_quality != result['breakout_quality']:
                        ...
                        result['reason'] = f"AI analysis suggests {ml_quality.replace('_', ' ').lower()} behavior with {int(prob*100)}% model confidence. Use it only with confirmed support, resistance, and trend alignment."
